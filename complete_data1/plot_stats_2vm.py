...
aimd_inrange_2 = [100.0, 95.18, 54.17, 98.11]
aimd_cpu_1 = [40.08, 39.5, 39.5, 41.6]
aimd_cpu_2 = [39.88, 45.01, 60.3, 58.26]



apid_tb_inrange_1 = [96.43, 81.13, 77.63, 89.61]
apid_tb_inrange_2 = [98.21, 95.0, 50.82, 94.44]
apid_tb_cpu_1 = [42.17, 40.26, 36.31, 41.28]
apid_tb_cpu_2 = [43.06, 48.62, 58.95, 59.58]



static_tb_inrange_1 = [100.0, 100.0, 2.9, 0.0]
static_tb_inrange_2 = [100.0, 2.74, 0.0, 100.0]
static_tb_cpu_1 = [50.0, 50.0, 50.0, 50.0]
static_tb_cpu_2 = [50.0, 50.0, 50.0, 50.0]
